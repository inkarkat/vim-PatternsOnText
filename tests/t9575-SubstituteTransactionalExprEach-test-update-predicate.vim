...
edit text.txt
call vimtap#err#Errors('Substitution aborted by update predicate', '%SubstituteTransactionalExprEach /"\\<....\\>"/"XXXX"/gt/let v:val.n += len(substitute(submatch(0), "[^aeiou]", "", "g"))/u/v:val.n > 10/', 'false value aborts substitution')
