...
edit text.txt
call vimtap#err#Throws('Substitution aborted by update predicate', '%SubstituteTransactional /\<....\>/XXXX/gt/let v:val.n += len(substitute(submatch(0), "[^aeiou]", "", "g"))/u/v:val.n > 10/', 'false value aborts substitution')
